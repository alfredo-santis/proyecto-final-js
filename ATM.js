...
document.getElementById('montoIngreso').addEventListener('focus', function() {
    inputActivo = this;
});

document.getElementById('montoRetiro').addEventListener('focus', function() {
    inputActivo = this;
});
